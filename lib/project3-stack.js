...
class Project3Stack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const githubRepo = "User_Native_Monitoring_System";
    ...
    emailTopic.addSubscription(new subscriptions.EmailSubscription('thisemailforhack1234@gmail.com'));
    ...
    emailTopic.addSubscription(new subscriptions.LambdaSubscription(lambdaFunction));    
